...
constexpr char LogDirectory[] = "sdmc:/nxrv/toolbox";
...
/*
 * Raw bsd:s lifecycle matching libnx initialization.
 * Enable phases one at a time after the root registration is repeatable.
 */
constexpr bool EnableScenarioManualBsdLifecycle = true;
constexpr bool ManualBsdOpenMonitorSession = false;
constexpr bool ManualBsdCreateTransferMemory = true;
constexpr bool ManualBsdRegisterClient = true;
constexpr bool ManualBsdStartMonitoring = false;
...
/* Normal bsd:s UDP workload used to validate the toolbox-only MITM path. */
...
constexpr char TcpPayload[] = "nxrv-toolbox-tcp";
...
constexpr char UdpPayload[] = "nxrv-toolbox-udp";
